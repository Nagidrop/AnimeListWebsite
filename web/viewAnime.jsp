                                            ...
                                            <tbody><tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="spaceit">
                                                        ...
                                                        <input type="text" id="myinfo_watchedeps" name="progress" size="3" class="inputtext form-control-sm" value="<%= animeInList.getProgress()%>" style="border: 1px solid #ced4da!important; font-size: 1rem!important;" /> / <span id="curEps">                                
