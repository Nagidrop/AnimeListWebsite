...
<html>
    ...
    <body class="container">
        ...
        <div class=""><p></div>
        <div class="row">
            <div class="col-md-7" ><h3>All Anime:</h3></div>
            <div class="col-md-5" >
                <div class="d-flex flex-row-reverse">
                    ...
                    <div class="dropdown p-2">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="<s:url action="sortAllAnimeByName"/>">Name</a>
                            <a class="dropdown-item" href="<s:url action="sortAllAnimeBySeason"/>">Season</a>
                            <a class="dropdown-item" href="<s:url action="sortAllAnimeByEpisode"/>">Episode</a>
                        </div>
                    </div>
        ...
        <div class="row mb-3 ">
            ...
            <div class="row">
                <h5>We Don't Have Any Anime Yet</h5>
            </div>
            <%}%>
    </body>
</html>
