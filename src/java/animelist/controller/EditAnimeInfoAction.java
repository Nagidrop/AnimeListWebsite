 ...
 * @author HAPPY
 */
public class EditAnimeInfoAction extends ActionSupport implements ServletRequestAware {
    ...
    public String execute() throws Exception {
        try {
            ...
            int id = Integer.parseInt(request.getParameter("animeid"));
            ...
            if (poster != null) {
                ...
                posterFileName = request.getParameter("posterName");
            }
            System.out.println(posterFileName);
            System.out.println(path);
            dao.deleteAnimeStudio(id);
