    ...
    <ul class="nav navbar-nav">
        <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="<s:url action="ViewUserTotalAnimes"/>">Change Password</a>
                <a class="dropdown-item" href="<s:url action="ViewUserTotalAnimes"/>">Change Info</a>
